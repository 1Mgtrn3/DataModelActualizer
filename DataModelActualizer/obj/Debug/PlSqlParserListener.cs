...
public interface IPlSqlParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterRelational_properties([NotNull] PlSqlParser.Relational_propertiesContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="PlSqlParser.relational_properties"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitRelational_properties([NotNull] PlSqlParser.Relational_propertiesContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTable_ref_aux_internal([NotNull] PlSqlParser.Table_ref_aux_internalContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="PlSqlParser.table_ref_aux_internal"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTable_ref_aux_internal([NotNull] PlSqlParser.Table_ref_aux_internalContext context);
